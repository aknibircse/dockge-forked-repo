...
export default {
    ...
    computed: {
        ...
        service() {
            ...
            } else if (this.objectType === "x-rackge") {

                if (!this.$parent.$parent.jsonConfig["x-rackge"]) {
                    return {};
                }

                // Used in Compose.vue
                return this.$parent.$parent.jsonConfig["x-rackge"];
            } else {
                return {};
            }
        },
    ...
    methods: {
        addField() {
            ...
            if (this.objectType === "x-rackge") {
                if (!this.$parent.$parent.jsonConfig["x-rackge"]) {
                    this.$parent.$parent.jsonConfig["x-rackge"] = {};
                }
            }
